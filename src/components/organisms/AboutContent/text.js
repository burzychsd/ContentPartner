export const text = [
    ...
    otrzymałem pierwsze zlecenie na pisanie artykułów pod kątem SEO. Zrozumiałem, że oto
    ...
    prawda? Literatura piękna, muzyka bez podziału na gatunki, piłka nożna, Bydgoszcz, w której żyję
    od urodzenia... Poznaj pasjonata, który postanowił stać się specjalistą od słowa i próbuje swoich sił
    jako przedsiębiorca.`,
    `Ale znacznie ciekawsze będzie pisanie o tym, czego dotyczy Twoja działalność. Powierz to
    zadanie komuś, dla kogo słowa to nie tylko zbiór znaków.`
]